...
alter table "public"."plaid_accounts"
    add constraint "plaid_accounts_account_id_key" UNIQUE using index "plaid_accounts_account_id_key";

alter table "public"."transactions"
    add constraint "transactions_account_id_fkey" FOREIGN KEY (account_id) REFERENCES plaid_accounts (account_id) ON DELETE CASCADE not valid;
